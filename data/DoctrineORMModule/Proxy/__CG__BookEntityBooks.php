...
namespace DoctrineORMModule\Proxy\__CG__\Book\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Books extends \Book\Entity\Books implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Book\\Entity\\Books' . "\0" . 'id', '' . "\0" . 'Book\\Entity\\Books' . "\0" . 'name', '' . "\0" . 'Book\\Entity\\Books' . "\0" . 'price', '' . "\0" . 'Book\\Entity\\Books' . "\0" . 'isbn');
        }
