 ...
 */
class Music extends \Music\Entity\Music implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Music\\Entity\\Music' . "\0" . 'id', '' . "\0" . 'Music\\Entity\\Music' . "\0" . 'name', '' . "\0" . 'Music\\Entity\\Music' . "\0" . 'duration', '' . "\0" . 'Music\\Entity\\Music' . "\0" . 'album');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Music $proxy) {
